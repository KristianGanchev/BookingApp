...
namespace BookingApp.Infrastructure.Migrations
{
    ...
    [Migration("20240426164434_Create_Database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingApp.Domain.Apartments.Apartment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("BookingApp.Domain.Reviews.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("BookingApp.Domain.Apartments.Apartment", b =>
                {
                    b.OwnsOne("BookingApp.Domain.Apartments.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("BookingApp.Domain.Shared.Money", "CleaningFee", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("BookingApp.Domain.Bookings.Booking", b =>
                {
                    b.HasOne("BookingApp.Domain.Apartments.Apartment", null)
                        .WithMany()
                        .HasForeignKey("ApartmentId")
            ...
            modelBuilder.Entity("BookingApp.Domain.Reviews.Review", b =>
                {
                    ...
                    b.HasOne("BookingApp.Domain.Bookings.Booking", null)
                        .WithMany()
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
